...
window.onload = function () {
    ...
    for (var i = 0; i < allco.length; i++) {
        allco[i].onclick = inputClickHandlero;
    }
};
...
function inputClickHandler(e) {
    ...
    if (tdElm.style.backgroundColor == 'brown') {
        tdElm.style.backgroundColor = 'white';
    } else {
        tdElm.style.backgroundColor = 'brown';
    }
}

function inputClickHandlero(e) {
    //console.log("NOTEBOOOKINPUT")
    e = e || window.event;
    var tdElm = e.target || e.srcElement;
    if (tdElm.style.backgroundColor == 'brown') {
        tdElm.style.backgroundColor = '#e5e5e5';
    } else {
        tdElm.style.backgroundColor = 'brown';
    }
}
